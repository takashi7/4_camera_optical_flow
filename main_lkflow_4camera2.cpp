...
//	//------------------------------------
//	// File
//	std::ofstream record("4camera3.csv");
//	int ft = 0;
//	//------------------------------------
//
//	while (1) {
...
//		//------------------------------------------------------------------
//
//		std::vector<double> T{ Filter_test.m_vx , Filter_test.m_vy , Filter_test.m_vz , Filter_test.m_wx , Filter_test.m_wy , Filter_test.m_wz };
//
